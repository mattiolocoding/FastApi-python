...
#dare api titolo e metadata aggiuntivi
#descrizione supporta markdown
app = FastAPI(
...
#metadata e attributi
#informazioni che verranno stampate automaticamente come annotazioni
